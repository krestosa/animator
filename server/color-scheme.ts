...
export function resolvePreviewColorScheme(explicit:PreviewColorScheme|undefined,referer:string|null|undefined,_isDocument:boolean,current:PreviewColorScheme):PreviewColorScheme{
