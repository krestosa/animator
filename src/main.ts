...
const cleanup = (): void => { cleanupDomLoadTree(); cleanupLoadTimeline(); cleanupTimelineTools(); cleanupRemoteOpen(); cleanupMotionCatalog(); cleanupPreviewEditor(); cleanupPreviewOrigin(); cleanupTimeline(); cleanupPolish(); cleanupExtras(); cleanupApp(); };
