...
const cleanup = (): void => { cleanupDomLoadTree(); cleanupLoadTimeline(); cleanupPreviewCamera(); cleanupTimelineTools(); cleanupRemoteOpen(); cleanupMotionCatalog(); cleanupPreviewEditor(); cleanupPreviewOrigin(); cleanupTimelineLabels(); cleanupTimeline(); cleanupPolish(); cleanupExtras(); cleanupApp(); };
