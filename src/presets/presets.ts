...
export const presets: AnimationPreset[] = [
  ...
  {id:'fade-left',label:'Fade Left',keyframes:[{opacity:0,transform:'translateX(24px)'},{opacity:1,transform:'translateX(0px)'}],duration:500,easing:'ease-out'},
  {id:'fade-right',label:'Fade Right',keyframes:[{opacity:0,transform:'translateX(-24px)'},{opacity:1,transform:'translateX(0px)'}],duration:500,easing:'ease-out'},
  ...
  {id:'scale-out',label:'Scale Out',keyframes:[{opacity:1,transform:'scale(1)'},{opacity:0,transform:'scale(.9)'}],duration:320,easing:'ease-in'},
  ...
  {id:'slide-out',label:'Slide Out',keyframes:[{transform:'translateX(0px)'},{transform:'translateX(40px)'}],duration:420,easing:'ease-in'},
  {id:'blur-in',label:'Blur In',keyframes:[{opacity:0,filter:'blur(12px)'},{opacity:1,filter:'blur(0px)'}],duration:500,easing:'ease-out'},
  {id:'blur-out',label:'Blur Out',keyframes:[{opacity:1,filter:'blur(0px)'},{opacity:0,filter:'blur(12px)'}],duration:450,easing:'ease-in'},
  ...
  {id:'expand',label:'Expand',keyframes:[{opacity:0,transform:'scaleY(0)'},{opacity:1,transform:'scaleY(1)'}],duration:320,easing:'ease-out'},
