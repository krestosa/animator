import { detectedAnimationToMotionTrack,type MotionTrack } from '../core/motion';
...
export function saveCustomPreset(label:string,animation:DetectedAnimation):CustomPreset[] { return saveCustomMotionPreset(label,detectedAnimationToMotionTrack(animation)); }
