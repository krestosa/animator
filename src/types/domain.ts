...
export interface DetectedAnimation {
  id: string; elementId: string; type: AnimationType; name?: string; startTime: number; duration?: number; delay?: number;
  iterations?: number; direction?: string; easing?: string; fill?: string; properties: AnimatedProperty[];
...
export type EditorCommand =
 ...
 | {source:'animator-editor'; type:'APPLY_OVERRIDE'; animationId:string; duration?:number; easing?:string; keyframes?:Array<Record<string, string | number | null>>}
