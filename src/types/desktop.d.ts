...
type DesktopBlinkViewport={x:number;y:number;width:number;height:number;zoomFactor:number;clipX?:number;clipY?:number;clipWidth?:number;clipHeight?:number};
  ...
  interface Window {
    animatorDesktop?: {
      blink: {
        ...
        setViewport:(viewport:DesktopBlinkViewport)=>void;
