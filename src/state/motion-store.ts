import { detectedAnimationToMotionTrack,detectedAnimationsToMotionTracks,motionTracksToDetectedAnimations,type MotionKeyframe,type MotionTrack } from '../core/motion';
